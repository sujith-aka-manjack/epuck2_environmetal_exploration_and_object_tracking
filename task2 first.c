...
#define obj_far 400  	//value if obj is considered as far
#define obj_near 600	//value if obj is considered as close
#define obj_max 20		//value if obj is farther than detectable range by prox sensor
#define obj_min 1250	//value if obj is closer than detectable range by prox sensor
